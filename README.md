...
To find the line of best fit, we need to determine the values of vector $`x`$ that make $`A`$ most closely approximate $`\vec{b}`$. To do this we first need to use QR factorization.
